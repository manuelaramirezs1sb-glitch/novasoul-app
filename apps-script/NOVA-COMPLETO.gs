 ...
 *
 * ┌─ INSTALACIÓN (una vez, en la cuenta de Nova) ──────────────┐
 * │   1) instalarNova()          carpeta, 4 hojas, pestañas    │
 * │   2) crearNutrea()           tu hoja de operación          │
 * │   3) instalarTriggerTasas()  tasas al día, solas           │
 * │   4) probarApi()             confirma que Equipo está bien │
 * │                                                            │
 * │   Después: Implementar → Nueva implementación →            │
 * │            Aplicación web · Ejecutar como: Yo ·            │
 * │            Acceso: Cualquier usuario                       │
 * └────────────────────────────────────────────────────────────┘
 *
 * Contiene:
 *   1. Bootstrap ....... instalación y estructura de los workbooks
 *   2. Estados ......... estados canónicos + teléfonos de 24 países
 *   3. Monedas ......... 35 monedas y conversión con la tasa del día
 *   4. Importadores .... las pestañas _Import_* → filas normalizadas
 *   5. Auto-mapeo ...... fuentes nuevas sin export de muestra
 *   6. Provisionar ..... crea la hoja de un cliente
 *   7. Tasas ........... tasas automáticas y efecto cambiario
 *   8. API ............. el puente con las pantallas
 *
 * ÚTILES:
 *   cuentaActual()              en qué cuenta corre esto
 *   verInstalacion()            a qué hojas apunta
 *   listarClientes()            clientes y sus hojas
 *   probarApi()                 simula un login sin salir del editor
 *   actualizarTasas()           trae las tasas que falten
 *   alarmaTasa()                avisa si la tasa se movió
 ...
 *   diagnosticar(fuente,td)     revisa el mapeo de una fuente
 */
